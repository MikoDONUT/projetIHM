Public Class ModifierListe
    ...
    Dim priceTot As Integer = 0
        ...
        Private Sub Button3_Click(sender As Object, e As EventArgs) Handles BtnSurgelé.Click
            ...
            ChoisirSurgelés.Label1.Text = Label1.Text

        ElseIf Form1.Label2.Text = "Economique" Then
                IsEco.Text = "Economique"
                EcoSurgele.Show()

            EcoSurgele.Label1.Text = Label1.Text
        ...
        Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
            ...
            ChoisirFruitEtLegumes.Label1.Text = Label1.Text

        ElseIf Form1.Label2.Text = "Economique" Then
                IsEco.Text = "Economique"
                EcoFruitLegumes.Show()

            EcoFruitLegumes.Label1.Text = Label1.Text
        End If
        ...
        Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
            ...
            ChoisirEpice.Label1.Text = Label1.Text

        ElseIf Form1.Label2.Text = "Economique" Then
                IsEco.Text = "Economique"
                EcoEpice.Show()

            EcoEpice.Label1.Text = Label1.Text
        End If
        ...
        Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
            ...
            ChoisirProduitDuMonde.Label1.Text = Label1.Text

        ElseIf Form1.Label2.Text = "Economique" Then
                IsEco.Text = "Economique"
                EcoProduitDuMonde.Show()

            EcoProduitDuMonde.Label1.Text = Label1.Text
        End If
        ...
        Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
            btnSaveClicked = True
        Form1.ListProduit.Items.Add(Label1.Text)
